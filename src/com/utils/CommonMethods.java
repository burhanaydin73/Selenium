...
public class CommonMethods {
	...
	public static void setUp(String browser, String url) {
		...
		if (browser.equalsIgnoreCase("chrome")) {
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\burha\\eclipse-workspace\\SeleniumBatchV\\drivers\\chromedriver.exe");
			driver = new ChromeDriver();
		} else if (browser.equalsIgnoreCase("firefox")) {
			System.setProperty("webdriver.gecko.driver", "C:\\Users\\burha\\eclipse-workspace\\SeleniumBatchV\\drivers\\geckodriver.exe");
